...
func adjustStageLabel():
	match GameManager.gameLocale:
		"en":
			...
			ability_msg_label.add_theme_font_override("font", FontConstants.PIXEL_OPERATOR_8)
			ability_msg_label.add_theme_font_size_override("font_size", 8)
			
			ability_msg_label_2.add_theme_font_override("font", FontConstants.PIXEL_OPERATOR_8)
			ability_msg_label_2.add_theme_font_size_override("font_size", 8)
			
			exit_msg_label.add_theme_font_override("font", FontConstants.PIXEL_OPERATOR_8)
			exit_msg_label.add_theme_font_size_override("font_size", 8)
		"ja":
			coin_msg_label.add_theme_font_override("font", FontConstants.LANA_PIXEL)
			coin_msg_label.add_theme_font_size_override("font_size", 11)
			
			ability_msg_label.add_theme_font_override("font", FontConstants.LANA_PIXEL)
			ability_msg_label.add_theme_font_size_override("font_size", 11)
			
			ability_msg_label_2.add_theme_font_override("font", FontConstants.LANA_PIXEL)
			ability_msg_label_2.add_theme_font_size_override("font_size", 11)
			
			exit_msg_label.add_theme_font_override("font", FontConstants.LANA_PIXEL)
